...
class LimbRiggerWidget(QWidget):
    ...
    def BuildRig(self):
        ...
        mel.eval(f"curve -d 1 -n {ikfkBlendCtrlName} -p -1 1 0 -p -3 1 0 -p -3 -1 0 -p -1 -1 0 -p -1 -3 0 -p 1 -3 0 -p 1 -1 0 -p 3 -1 0 -p 3 1 0 -p 1 1 0 -p 1 3 0 -p -1 3 0 -p -1 1 0 -k 0 -k 1 -k 2 -k 3 -k 4 -k 5 -k 6 -k 7 -k 8 -k 9 -k 10 -k 11 -k 12 ;")
    ...
    def GetWindowUniqueId():
        return "aa584b1c171b318273be801b251d0405"
